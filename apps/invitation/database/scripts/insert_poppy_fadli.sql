-- INSERT query for Poppy & Fadli invitation
-- Based on masterMockPoppyFadli.ts
-- Table: invitation_contents
-- Using dollar-quoted strings ($$) for safe escaping

INSERT INTO public.invitation_contents (
  slug,
  client_profile,
  bride,
  groom,
  ...
  $${
    "slug": "poppy-fadli",
    "coupleNames": "Poppy & Fadli",
    "weddingDateLabel": "Sabtu, 27 Desember 2025",
    "locationLabel": "Semarang, Jawa Tengah",
    "shortDescription": "Undangan Pernikahan Poppy Senorita Setyawati dan Fadli Perdana.",
    ...
    "metaTitle": "Wedding Poppy & Fadli",
    "metaDescription": "Undangan digital pernikahan Poppy Senorita Setyawati & Fadli Perdana — Sabtu, 27 Desember 2025, Semarang."
  }$$::jsonb,
  
  -- bride
  $${
    "name": "Poppy",
    "fullName": "Poppy Senorita Setyawati",
    "fatherName": "Bapak Sarwito Eliyanto",
    "motherName": "Ibu Sulistyowati",
    "instagram": "poppssee"
  }$$::jsonb,
  ...
  $${
    "name": "Fadli",
    "fullName": "Fadli Perdana",
    "fatherName": "Bapak Ambia Muhamad Rusan",
    "motherName": "Ibu Rosneliwati (Almh)",
    "instagram": "vadleeprdna"
  }$$::jsonb,
  
  -- event
  $${
    "fullDateLabel": "Sabtu, 27 Desember 2025",
    "isoDate": "2025-12-27",
    "countdownDateTime": "2025-12-27T08:00:00+07:00",
    "eventTitle": "The Wedding of Poppy & Fadli",
    "calendarLink": null
  }$$::jsonb,
  ...
  $${
    ...
    "streaming": {
      "description": "For guests who are unable to attend, you can watch the event\nthrough the link below.",
  ...
  $${
    ...
    "blocks": [
      ...
      },
      {
        ...
        "body": "We're so grateful for you being a part of our lives. We hope you'll join us in celebrating this special day with us."
      }
    ]
  }$$::jsonb,
  ...
  $${
    "title": "Wedding Gift",
    "subtitle": "We're so grateful for your love and support any gift you share means the world to us.",
