...
import { getGuestTypeStats } from '@/lib/guestbook/repositories/guestTypeRepository';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const stats = await getGuestTypeStats(eventId);
    ...
    console.error('Get guest type stats error:', error);
    return NextResponse.json(
