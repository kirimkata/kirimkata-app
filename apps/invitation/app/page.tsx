            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Kami akan memberikan revisi jika terdapat kesalahan penulisan dalam undangan.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '1rem' }}>
                                    <a
                                        href="https://www.instagram.com/kirimkata_com"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        style={{
                                            fontSize: '0.875rem',
                                    ...
                                    <a
                                        href="https://www.tiktok.com/@kirimkata.com"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        style={{
                                            fontSize: '0.875rem',
                        ...
                        >
                            &copy; {new Date().getFullYear()} KirimKata. All rights reserved.
                        </div>
                    </div>
                </footer>
            </div>
