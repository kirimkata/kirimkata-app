// Centralized master mock config for Poppy & Fadli invitation
// All editable copy/text for this invitation should be managed here.

import { flushAllTraces } from "next/dist/trace";

export const masterMockPoppyFadli = {
  clientProfile: {
    slug: 'poppy-fadli',
    ...
    shortDescription:
      'Undangan Pernikahan Poppy Senorita Setyawati dan Fadli Perdana.',
    ...
    metaDescription:
      'Undangan digital pernikahan Poppy Senorita Setyawati & Fadli Perdana — Sabtu, 27 Desember 2025, Semarang.',
    loadingDesign: 'custom1' as const, // Use custom animated loading overlay
  },

  // High level summary used by InvitationRepository
  invitationSummary: {
    clientNames: 'Poppy & Fadli',
    eventDateLabel: 'Sabtu, 27 Desember 2025',
    locationLabel: 'Semarang, Jawa Tengah',
    ...
    additionalNotes: 'Sample data via InvitationRepository stub.',
  },
...
export type MasterMockPoppyFadli = typeof masterMockPoppyFadli;
