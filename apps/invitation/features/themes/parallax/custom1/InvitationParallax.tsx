...
import { getAssetManifest, type AssetResource } from '@/config/assetManifest';
...
export default function InvitationParallax({ clientSlug, guestName, loadingDesign: themeLoadingDesign }: InvitationParallaxProps) {
