...
import { getImage, getCoupleGroupPosition } from '@/config/imageConfig';
import { SECTION_LAYOUTS } from '@/config/sectionLayoutConfig';
import { GUNUNGAN_CONFIG } from '@/config/gununganConfig';
import { LAYER_VISIBILITY_CONFIG } from '@/config/layerVisibilityConfig';
import { BACKGROUND_OVERLAY_CONFIG } from '@/config/backgroundOverlayConfig';
